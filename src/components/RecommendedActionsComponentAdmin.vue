<template>
  ...
  >
    ...
    <v-list>
      <v-list-item @click="changeRoute('admin-inventory');">
      ...
      <v-list-item @click="changeRoute('admin-active-orders');">
        <v-list-item-avatar class="d-none d-lg-block">
          <v-icon class="grey lighten-1 white--text">mdi-inbox</v-icon>
        </v-list-item-avatar>
        <v-list-item-content>
          <v-list-item-title class="primary--text">View your orders</v-list-item-title>
          <v-list-item-subtitle>View orders that come your way</v-list-item-subtitle>
        </v-list-item-content>
        <v-list-item-action>
          <v-icon>mdi-arrow-right</v-icon>
        </v-list-item-action>
      </v-list-item>
      <v-list-item @click="changeRoute('admin-stats');">
        <v-list-item-avatar class="d-none d-lg-block">
...
import Vue from "vue";
export default {
  name: 'RecommeendedActionsComponentAdmin',
